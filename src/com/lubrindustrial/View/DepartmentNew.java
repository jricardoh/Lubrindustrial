 ...
 * @author Marcelo
 */
public class DepartmentNew extends javax.swing.JInternalFrame {
...
//        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try{
            ...
            if(depCRUD.insertar(dep)){
                JOptionPane.showMessageDialog(null, "DEPARTAMENTO REGISTRADO","REGISTRO EXITOSO",JOptionPane.INFORMATION_MESSAGE);
                Volver();
            }else{
                JOptionPane.showMessageDialog(null, "DEPARTAMENTO NO REGISTRADO","ERROR EN EL REGISTRO", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){

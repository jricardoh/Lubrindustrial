...
//        tab_departments.doLayout();
    ...
    private void agregarDatos() {
        ...
        for (Department d : departamentos) {
            datos[0] = Integer.toString(d.getIdDepartment());
            datos[1] = d.getNroDepartment();
            datos[2] = d.getDescDepartment();
            model.addRow(datos);
        }

    }

    private String[] arregloDepartamentos(int idDept){
    ...
    private void initComponents() {
        ...
        tab_departments = new javax.swing.JTable();
        ...
        tab_departments.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Id Departamento", "Número de Departamento", "Descripcion Departamento"
            }
        ));
        tab_departments.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tab_departmentsMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tab_departments);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Búsqueda"));

        cbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Número Departamento", "Descripción" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbox, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tab_departmentsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab_departmentsMouseClicked

    }//GEN-LAST:event_tab_departmentsMouseClicked
    ...
    private void txtInputKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtInputKeyReleased
        ...
        if (txtInput.getText().isEmpty()) {
            ...
            for (int i = 0; i < tab_departments.getRowCount(); i++) {
                modelo.removeRow(i);
                i -= 1;
            }

        } else {
            departamentos = dept_query.visualizar(txtInput.getText(), seleccionaritem());
...
//        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int filasel = tab_departments.getSelectedRow();
        if (filasel == -1) {
...
//        this.dispose();
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (filasel == -1) {
            ...
            dat = arregloDepartamentos(Integer.parseInt(tab_departments.getValueAt(filasel, 0).toString()));
            DepartmentEdit.lblID.setText(dat[0]);
            DepartmentEdit.txt_Number.setText(dat[1]);
            DepartmentEdit.txt_description.setText(dat[2]);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(reporte.escribirExcelDepartamentos(deps)){
            ...
            JOptionPane.showMessageDialog(null, "ARCHIVO EXCEL DE DEPARTAMENTOS NO CREADO","EROOR EN GUARDADO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JTable tab_departments;

 ...
 * @author Marcelo
 */
public class SupplierNew extends javax.swing.JInternalFrame {
...
//        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try{
            ...
            if(supCRUD.insertar(sup)){
                JOptionPane.showMessageDialog(null, "PROVEEDOR REGISTRADO","REGISTRO EXITOSO",JOptionPane.INFORMATION_MESSAGE);
                Volver();
            }else{
                JOptionPane.showMessageDialog(null, "PROVEEDOR NO REGISTRADO","ERROR EN EL REGISTRO", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){
